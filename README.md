...
No license file is currently attached to this repo — until one is
added, treat this as "all rights reserved, free to use privately" rather
than open source in the formal sense. (Consider adding an MIT or
Apache-2.0 license file if you want to explicitly permit reuse,
modification, and redistribution — happy to help pick one if useful.)
